...
public static class TableCreator
{
    ...
    extension<T>(IEnumerable<T> list) where T : class
    {
        /// <summary>
        ...
        public string CreateTable(TableCreatorOptions options)
        {
        ...
        /// <param name="options">The options for the creation of the table.</param>
        /// <exception cref="ArgumentNullException">Will be thrown if the provided list is <see langword="null"/>.</exception>
        public void SaveTable(string filepath, TableCreatorOptions options)
        {
            var result = CreateTable((DataTable)list, options);
        ...
        /// <exception cref="ArgumentNullException">Will be thrown if the provided list is <see langword="null"/></exception>
        public async Task SaveTableAsync(string filepath, TableCreatorOptions options)
        {
            var result = CreateTable((DataTable)list, options);
    ...
    extension<T>(T value) where T : class
    {
        ...
        public string CreateValueList(TableCreatorListOptions options)
        {
        ...
        /// <exception cref="ArgumentNullException">Will be thrown when the value is null</exception>
        /// <exception cref="NotSupportedException">Will be thrown when the specified type is assignable from IEnumerable</exception>
        public string CreateValueTable(TableCreatorOptions options)
        {
            Helper.ThrowIfNotSupported<T>();
        ...
        /// <exception cref="NotSupportedException">Will be thrown when the specified type is assignable from IEnumerable</exception>
        /// <exception cref="ArgumentNullException">Will be thrown when the value is null</exception>
        public void SaveValue(string filepath, TableCreatorListOptions options)
        {
        ...
        /// <exception cref="NotSupportedException">Will be thrown when the specified type is assignable from IEnumerable</exception>
        public void SaveValueAsTable(string filepath, TableCreatorOptions options)
        {
            Helper.ThrowIfNotSupported<T>();
        ...
        /// <exception cref="NotSupportedException">Will be thrown when the specified type is assignable from IEnumerable</exception>
        /// <exception cref="ArgumentNullException">Will be thrown when the value is null</exception>
        public async Task SaveValueAsync(string filepath, TableCreatorListOptions options)
        {
            var result = value.CreateValueList(options);
        ...
        /// <exception cref="ArgumentNullException">Will be thrown when the specified value is null</exception>
        /// <exception cref="NotSupportedException">Will be thrown when the specified type is assignable from IEnumerable</exception>
        public async Task SaveValueAsTableAsync(string filepath, TableCreatorOptions options)
        {
            Helper.ThrowIfNotSupported<T>();
